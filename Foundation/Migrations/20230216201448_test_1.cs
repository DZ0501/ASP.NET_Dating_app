        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    localization = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    interest1id = table.Column<int>(name: "interest_1_id", type: "int", nullable: true),
                    interest2id = table.Column<int>(name: "interest_2_id", type: "int", nullable: true),
                    interest3id = table.Column<int>(name: "interest_3_id", type: "int", nullable: true),
